...
def next():
    ...
    try:
        ...
        next()
# create buttons    
btn1 = Button(root, text="Previous", bg='purple', fg='gold', font=('ariel 15 bold'), relief=GROOVE, command=previous)
btn1.pack(side=LEFT, padx=60, pady=5)
btn2 = Button(root, text="Next", width=8, bg='purple', fg='gold', font=('ariel 15 bold'), relief=GROOVE, command=next)
btn2.pack(side=LEFT, padx=60, pady=5)
btn3 = Button(root, text="Exit", width=8, bg='purple', fg='gold', font=('ariel 15 bold'), relief=GROOVE, command=root.destroy)
